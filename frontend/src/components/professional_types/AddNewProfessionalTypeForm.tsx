...
import {createProfessionalType} from "@/api_service/professionalType.ts";
...
export default function AddNewProfessionalTypeForm({ onClose }: { onClose?: () => void }) {
    ...
    const mutation = useMutation({
        mutationFn: createProfessionalType,
        onSuccess: async () => {
